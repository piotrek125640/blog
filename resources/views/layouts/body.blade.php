<div class="container marketing" >
        ...
        <div class="row">
          <div class="col-lg-4">
            <img class="figure-img img-fluid rounded" src="http://www.canworld.ca/images/common.jpg" alt="Generic placeholder image" width="350" height="140">
            <h2>Diagnostyka</h2>
            <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
            <p><a class="btn btn-secondary" href="#" role="button">View details »</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            <img class="figure-img img-fluid rounded" src="http://www.canworld.ca/images/common.jpg" alt="Generic placeholder image" width="140" height="140">
            <h2>Transport</h2>
